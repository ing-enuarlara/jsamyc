<div class="page-width shopify-policy__container">
    ...
    <div class="shopify-policy__body">
        <div class="rte">
            ...
            <p>Cada método de envío tiene restricciones y costes propios, los cuales serán aplicados en tu pedido. Cuando pases por caja, se te solicitará que indiques una forma de envío para tu(s) producto(s). Antes de finalizar tu pedido, los costes totales de envío se calcularán automáticamente.</p>
            <p><strong>Normas y restricciones de envío</strong></p>
            <p>Los pedidos se envían solo en días hábiles. Los días hábiles son de lunes a viernes, excluyendo los festivos nacionales de Colombia.</p>
